...
```{r Wii Sports. Image, echo = FALSE, fig.align = 'center', out.width = "50%", fig.cap = "Wii Sports - Wikipedia"}
knitr::include_graphics("Wii_Sports_Europe.jpg")
```
...
#prints frequency of values in graph
